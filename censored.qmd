...
![Effects of truncation and censoring from Davidson and MacKinnon](davidson.png)
...
Both Stata (etregress in version 14) and SAS (qlim) can estimate the switching

...
$$ \hat\beta = \frac{d \cdot y}{d \cdot x}. $$ {#eq-outcome-weights-3}
...
$$ d \cdot v = \sum_{i \in R} d_i v_i + \sum_{i \in L} d_i v_i = W \bar v_R - W \bar v_L = W(\bar v_R - \bar v_L). $$ {#eq-outcome-weights-4}
...
$$ \hat\beta = \frac{d \cdot y}{d \cdot x} = \frac{W(\bar y_R - \bar y_L)}{W(\bar x_R - \bar x_L)} = \frac{\bar y_R - \bar y_L}{\bar x_R - \bar x_L}. $$ {#eq-outcome-weights-5}

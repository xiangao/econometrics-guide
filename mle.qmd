...
The information matrix is the expected value of the outer product of the gradient of the log-likelihood function, or the negative value of the expected value of the Hessian (second derivative of the log-likelihood function).
...
# Use OLS estimates as starting values; good starting values reduce the
# risk of the optimizer converging to a spurious local maximum.

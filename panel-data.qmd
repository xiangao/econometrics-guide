...
| $z_i$, with a time-varying $W_{it}$ also in the model | $\sum_t \tilde z_{it}^2$ |
...
time-invariant $z_i$ on something that moves within the unit makes
$\tilde z$ move within the unit as well, so the unit's weight no longer

...
\beta^l)}{\sum_{j=0}^J\exp({\bf W}_{tj} \beta^j)} \quad \mbox{for}
\ l=0, \dots, J,
$$
...
$j=0, \dots, J.$ For identification one category is taken as the base
with $\beta^0=0$ (so its numerator is $1$).

...
$$
\frac{h_1(t)}{h_2(t)} = \frac{h_0(t)\exp ({\bf x}_1' \beta)}{h_0(t)\exp ({\bf x}_2' \beta)}= \frac{\exp ({\bf x}_1' \beta)}{\exp ({\bf x}_2' \beta)},
$$
...
$$
h_0(t)\exp ({\bf x}'_i \beta + \beta_j) = \exp (\beta_j) h(t|{\bf x}_i)
$$
...
$$
\frac{h(t_j | {\bf x}_i)}{1- h(t_j | {\bf x}_i)} = \frac{h_0(t_j)}{1- h_0(t_j)} \exp({\bf x}'_i \beta),
$$
